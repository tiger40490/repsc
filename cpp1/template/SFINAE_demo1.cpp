...
//U will be the same type as T if one of the non-default candidates gets picked by the compiler.
//Otherwise, U is unbound/unused in the default candidate.
//function-template-overload resolution follows SNIFAE.

    template<typename U, U non_dummy_type_templ_param> class Check; // This nested class template is unreadably deep and convoluted.
    ...
    template<typename U> static double func(Check<long (U::*)() const, &U::sendTimeNS>*);//2nd item is a method, somehow
