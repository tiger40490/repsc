...
/**
 * At any time, the system is in exactly one of the states, but it may have zero or 1 target-state
 * 
 * If we don't query the sensors, we assume the state has not changed.
 * 
 * Warning: actual physical state of the drone is often unknown, such as a storm, or caught in trees
